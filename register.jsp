...
<body>
	...
	<div class="container col-md-4 pt-4">
	  ...
	  <form action="CheckRegisterServlet" class="was-validated" method="post">
	    ...
	    <button type="submit" class="btn btn-primary" onclick="CheckPassword(event)">Register</button>
	  </form>
	</div>
</body>
</html>